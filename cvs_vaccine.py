...
def findAVaccine():
    ...
    while time.time() < max_time:
        ...
        for item in payload["responsePayloadData"]["data"][state]:
            ...
            print(item)
        print(time.ctime())
        cities = ['FALLS CHURCH', 'VIENNA', 'CHANTILLY']  ###Update with your cities nearby
        for city in cities:
        ...
        time.sleep(600) ##This runs every 60 seconds. Update here if you'd like it to go every 10min (600sec)
        print('\n')
